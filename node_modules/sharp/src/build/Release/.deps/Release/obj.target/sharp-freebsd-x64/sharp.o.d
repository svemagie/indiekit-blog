cmd_Release/obj.target/sharp-freebsd-x64/sharp.o := c++ -o Release/obj.target/sharp-freebsd-x64/sharp.o ../sharp.cc '-DNODE_GYP_MODULE_NAME=sharp-freebsd-x64' '-DUSING_UV_SHARED=1' '-DUSING_V8_SHARED=1' '-DV8_DEPRECATION_WARNINGS=1' '-D_GLIBCXX_USE_CXX11_ABI=1' '-D_FILE_OFFSET_BITS=64' '-D_LARGEFILE_SOURCE' '-D__STDC_FORMAT_MACROS' '-DG_DISABLE_ASSERT' '-DG_DISABLE_CAST_CHECKS' '-DG_DISABLE_CHECKS' '-DNAPI_VERSION=9' '-DNODE_ADDON_API_DISABLE_DEPRECATED' '-DNODE_API_SWALLOW_UNTHROWABLE_EXCEPTIONS' '-DSHARP_USE_GLOBAL_LIBVIPS' '-DBUILDING_NODE_EXTENSION' -I/root/.cache/node-gyp/24.13.0/include/node -I/root/.cache/node-gyp/24.13.0/src -I/root/.cache/node-gyp/24.13.0/deps/openssl/config -I/root/.cache/node-gyp/24.13.0/deps/openssl/openssl/include -I/root/.cache/node-gyp/24.13.0/deps/uv/include -I/root/.cache/node-gyp/24.13.0/deps/zlib -I/root/.cache/node-gyp/24.13.0/deps/v8/include -I../../../node-addon-api -I/usr/local/include -I/usr/local/include/ImageMagick-7 -I/usr/local/include/librsvg-2.0 -I/usr/local/include/gdk-pixbuf-2.0 -I/usr/local/include/cairo -I/usr/local/include/libxml2 -I/usr/local/include/pango-1.0 -I/usr/local/include/fribidi -I/usr/local/include/harfbuzz -I/usr/local/include/OpenEXR -I/usr/local/include/Imath -I/usr/local/include/libraw -I/usr/local/include/libvmaf -I/usr/local/include/webp -I/usr/local/include/poppler/glib -I/usr/local/include/pixman-1 -I/usr/local/include/poppler -I/usr/local/include/freetype2 -I/usr/local/include/nss -I/usr/local/include/nspr -I/usr/local/include/openjpeg-2.5 -I/usr/local/include/libpng16 -I/usr/local/include/glib-2.0 -I/usr/local/lib/glib-2.0/include  -fPIC -pthread -Wall -Wextra -Wno-unused-parameter -m64 -O3 -fno-omit-frame-pointer -fno-rtti -fno-exceptions -fno-strict-aliasing -std=gnu++20 -std=c++17 -fexceptions -Wall -Os -MMD -MF ./Release/.deps/Release/obj.target/sharp-freebsd-x64/sharp.o.d.raw   -c
Release/obj.target/sharp-freebsd-x64/sharp.o: ../sharp.cc \
  ...
  /usr/local/include/glib-2.0/glib/gpathbuf.h \
  ...
  /usr/local/include/vips/private.h /usr/local/include/vips/image.h \
  /usr/local/include/vips/region.h /usr/local/include/vips/memory.h \
  ...
  /usr/local/include/vips/vips7compat.h /usr/local/include/vips/mask.h \
  ...
  ../././common.h .././pipeline.h .././stats.h .././utilities.h
../sharp.cc:
../../../node-addon-api/napi.h:
/root/.cache/node-gyp/24.13.0/include/node/node_api.h:
/root/.cache/node-gyp/24.13.0/include/node/js_native_api.h:
